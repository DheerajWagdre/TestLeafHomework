...
public class LogInAndLogOut extends SeMethods{
	...
	public void login() {
		...
		WebElement editButon = locateElement("linkText", "Edit");
		click(editButon);
		
		WebElement firstName1 = locateElement("id", "updateLeadForm_firstName");
		type(firstName1,"Balajii");
		
		WebElement updateLeadButton = locateElement("class", "smallSubmit");
		click(updateLeadButton);
